...
class ValidationReport:
    ...
    def add_error(self, sku: str, field: str, message: str):
        ...
        self.errors.append({"sku": sku, "field": field, "message": message})

    def add_warning(self, sku: str, field: str, message: str):
        """Add a warning to the report."""
        self.warnings.append({"sku": sku, "field": field, "message": message})
...
class Validator:
    ...
    def validate_all(
        self, products: list[Product], variations: list[Variation]
    ) -> ValidationReport:
